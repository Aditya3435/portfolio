        ...
        <main className=" h-screen flex flex-col w-screen" ref={ref} id="home">
            {isInView &&
                <div className="m-auto flex flex-col gap-2">
                    <motion.div initial="hidden" animate="visible" variants={container} ref={myName}>
                        <h1 data-aos="fade-right" className="text-2xl max-sm:text-xl">Hi, my name is</h1>
                        <div className="container" data-scroll data-scroll-speed="0.7">
                            <AnimatedText text={"Aditya Maurya"} />
                        </div>
                    </motion.div>
                    <p className="typing-text text-4xl -mt-4 max-sm:text-xl mx-sm:mt-auto" ref={typingText}>
                        I am a{" "}
                        <span className="typed-text text-5xl max-sm:text-xl mx-sm:mt-auto" ref={typedTextRef}></span>
                        <span className="cursor blink" ref={cursorRef}>&nbsp;</span>
                    </p>
                    <div className="flex gap-8 mt-8 w-fit origin-top-left" ref={socialRef}>
                        <a href="https://www.instagram.com/aditya_m3435/" target="_blank"> <InstagramIcon /> </a>
                        <a href="https://github.com/Aditya3435" target="_blank"> <GitHubIcon /> </a>
                        <a href="https://in.linkedin.com/in/aditya-maurya-490081b4" target="_blank" > <LinkedInIcon /> </a>
                    </div>
                </div>
            }
