  ...
  return (
    <div className='flex justify-between'>
      ...
      <div className={styles.footer}>
        ...
        <a href='https://in.linkedin.com/in/aditya-maurya-490081b4'><MagneticGSAP><button className="hover:bg-black-100  font-semibold py-1 px-2 border border-gray-400 rounded shadow">Resume</button></MagneticGSAP></a>
